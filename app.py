...
if alert_count > 0:
    ...
    st.caption("→「市場構造」ページの散布図で、構造的な需要過多を確認してください。")
else:
...
if no_direct:
    ...
    st.caption("→「市場構造」ページの「直行便・競合状況」タブで、新規就航の機会を確認してください。")
...
| ページ | 問い |
|--------|------|
| 🗺️ サマリー | 3路線の主要指標を1枚で比較したい |

**STEP 2｜需要の根拠を固める**

| ページ | 問い |
|--------|------|
| 📈 需要の実証 | いつ・どの路線が高い？早期から売れているか？ |
""")
with col2:
    st.markdown("""
**STEP 3｜競争環境を読む**
...
| ページ | 問い |
|--------|------|
| 🔍 市場構造 | 直行便は？LCCは入っている？供給不足マップは？ |

**STEP 4｜誰に提案するかを決める**

| ページ | 問い |
|--------|------|
| 🎯 参入ターゲット | 未就航航空会社は？路線優先度スコアは？ |
""")
